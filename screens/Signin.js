  ...
  return (
    <View>
      ...
      >
        ...
        <TextInput placeholder="Phone Number" style={Style.textstyle} />

        <TextInput placeholder="Email id" style={Style.textstyle} />

        <TextInput placeholder="Password" style={Style.textstyle} />

        <TextInput placeholder="Conform Password" style={Style.textstyle} />

        <TextInput placeholder="Reedem Code" style={Style.textstyle} />
